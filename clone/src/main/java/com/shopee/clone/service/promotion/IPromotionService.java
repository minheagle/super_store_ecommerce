...
public interface IPromotionService {
    ...
    Boolean isValidPromotion(String name, Double purchasedAmount, Long seller_id);
    ResponseEntity<?> addPromotionBeLongUser(Long userId, List<Long> listPromotionId);
    //Call To this Service is Enough
    Boolean checkValidUsage(Long userId, String promotionName, Double purchasedAmount, Long seller_id);
    Boolean minusUsage(Long userId, String promotionName, Double purchasedAmount, Long seller_id);
    Boolean plusUsage(Long userId, String promotionName, Double purchasedAmount, Long seller_id);
